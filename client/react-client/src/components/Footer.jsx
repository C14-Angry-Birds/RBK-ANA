  ...
  return (
    ...
    <div className="footer-right">
      <p className="footer-company-about">
        ...
        <br/><br/> Do you like to watch movies online <br/><br/> <br/>and spend a lot of time looking  <br/><br/><br/>for something interesting? 
        So you can <br/><br/> <br/>follow RBK @ana.
      </p>
